...
<aside class="main-sidebar sidebar-dark-primary elevation-4">
    ...
    <a href="<?= Yii::$app->urlManager->createUrl(['/']) ?>" class="brand-link">
        ...
        <span class="brand-text font-weight-light">Wijaya Wedding</span>
    </a>
        ...
        <nav class="mt-2">
            ...
            echo \hail812\adminlte\widgets\Menu::widget([
                'items' => [
                    ...
                    ['label' => 'Paket Wedding', 'icon' => 'list', 'url' => ['/paket']],
                    ['label' => 'Transaksi', 'icon' => 'dollar-sign', 'url' => ['/transaksi']],
                    ['label' => 'User', 'icon' => 'user', 'url' => ['/account']],
