...
const Product: React.FC = () => {
  ...
  return (
    <>
      <div className="bg-[#F7F3EF] text-[#9D6A42] px-6 md:px-0 h-full">
            ...
            <>
              <div className="py-10 grid grid-cols-1 gap-6 md:grid-cols-2 lg:grid-cols-4  w-full ">
                {filteredPaket?.map((list, index) => (
                  <div
                    className="rounded overflow-hidden shadow-lg  w-full h-[70vh] md:h-[70vh] lg:h-[80vh] bg-white "
                    key={index}
                  >
